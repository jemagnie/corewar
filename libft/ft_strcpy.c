...
/*   Updated: 2019/01/21 13:52:11 by fcordon     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void		strcpy_not_same_alignement(t_longword dstp, t_longword srcp,
											size_t shift)
{
	t_longword			merge;
...
static void		strcpy_same_alignement(t_longword dstp, t_longword srcp)
{
	const t_longword	repeat_one = 0x0101010101010101UL;
	const t_longword	black_hole = 0x8080808080808080UL;
	t_longword			word;
